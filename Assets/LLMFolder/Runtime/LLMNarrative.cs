...
namespace LLMUnity
{
    ...
    /// </summary>
    public class LLMNarrative : MonoBehaviour
    {   
        ...
        [Model] public bool stream = false;
        ...
        [ModelAdvanced] public int numPredict = 225;
        ...
        [ModelAdvanced, Float(0f, 2f)] public float temperature = 0.1f;
        ...
        [ModelAdvanced, Int(-1, 100)] public int topK = 45;
        ...
        [Chat] public string AIName = "narrative creator";
        ...
        /// <summary>
        /// Set the system prompt for the LLMNarrative.
        /// </summary>
