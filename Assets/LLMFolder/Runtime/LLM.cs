...
namespace LLMUnity
{
    ...
    public class LLM : MonoBehaviour
    {
        ...
        List<LLMNarrative> clients = new List<LLMNarrative>();
        LLMLib llmlib;
        ...
        /// <summary>
        /// Registers a local LLMNarrative object.
        /// This allows to bind the LLMNarrative "client" to a specific slot of the LLM.
        /// </summary>
        /// <param name="llmCharacter"></param>
        /// <returns></returns>
        public int Register(LLMNarrative llmCharacter)
        {
        ...
        public async Task<string> Completion(string json, Callback<string> streamCallback = null)
        {
            ...
            UnityEngine.Debug.Log($"Response Time: {watch.ElapsedMilliseconds} ms");
